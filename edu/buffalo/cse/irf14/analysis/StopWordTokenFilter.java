...
public class StopWordTokenFilter extends TokenFilter {
	...
	public void filter(Token t)
	{
		...
		int i=0;
		String words[]={"its","be","at","if","of","is","are","not","why","who","where","will","us","me","you","I","am","a","and","all","but","by","did","do","for","he","she","in","no","on","off","our","only","out","so","the","this","to","up","was","we","were"};
